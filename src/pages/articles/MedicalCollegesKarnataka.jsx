...
export default function MedicalCollegesKarnataka() {
  ...
  const karnatakaMedicalColleges = useMemo(() => {
    return colleges
  ...
  // 2. Pagination Logic
  const totalPages = Math.ceil(karnatakaMedicalColleges.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  
  // 3. The specific 10 items for the current page
  const currentItems = karnatakaMedicalColleges.slice(indexOfFirstItem, indexOfLastItem);

  // Change page function with smooth scroll
  const paginate = (pageNumber) => {
    setCurrentPage(pageNumber);
    // Smoothly scroll back to the top of the list when changing pages
    ...
    <div style={styles.pageContainer}>
      ...
      <header style={styles.heroHeader}>
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.mainTitle}>Medical Colleges in Karnataka</h1>
          <p style={styles.subtitle}>
            A complete directory of institutions offering MBBS programs across Karnataka.
          </p>
      ...
      <main style={styles.mainContent} ref={listTopRef}>
        <div style={styles.listContainer}>
          {/* Map over currentItems instead of the full array */}
            ...
            <article key={college.id} style={styles.card}>
              <div style={styles.imageBox}>
                <div style={styles.rankRibbon}>
                  ...
                  {/* Calculate true ranking number globally */}
