...
export default function TopKarnatakaMedicalColleges() {
  ...
  const top10KarnatakaColleges = useMemo(() => {
    return colleges
      .filter(c => c.state === 'Karnataka' && c.courses.includes('MBBS'))
    ...
    <div style={styles.pageContainer}>
      ...
      <header style={styles.heroHeader}>
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.mainTitle}>Top 10 Medical Colleges in Karnataka</h1>
          <p style={styles.subtitle}>Explore the highest-rated medical hubs and universities across Karnataka.</p>
          <div style={styles.divider}></div>
          <p style={styles.introText}>
            Karnataka is widely recognized for hosting premier healthcare infrastructures and leading medical universities in India. Evaluating key milestones across patient intake volumes, infrastructure capacities, and direct institutional evaluations, we outline the definitive top 10 medical colleges in the state.
          </p>
        </div>
      </header>
      ...
      <main style={styles.mainContent}>
        <div style={styles.listContainer}>
          {top10KarnatakaColleges.length > 0 ? (
            top10KarnatakaColleges.map((college, index) => (
                ...
                <div style={styles.contentBox}>
                  ...
                  <div style={styles.explanationSection}>
                    ...
                    <p style={styles.description}>
                      {college.description || `Distinguished by its exhaustive clinical training facilities and exceptional research setups, ${college.name} sets premier parameters for medical studies. The institution features up-to-date diagnostic labs alongside well-integrated community healthcare initiatives.`}
                    </p>
                  </div>
                  ...
                  <div style={styles.dataGrid}>
                    ...
                    <div style={styles.dataItem}>
                      ...
                      <span style={styles.dataValue}>{college.affiliation || "RGUHS / Deemed"}</span>
                    </div>
                  </div>
            ...
            <div style={{ textAlign: 'center', padding: '40px', color: '#64748b' }}>
              <h2>No medical colleges discovered matching the criteria in Karnataka.</h2>
