...
export default function MedicalCollegesTamilNadu() {
  ...
  const tamilNaduMedicalColleges = useMemo(() => {
    return colleges
  ...
  // 2. Pagination Logic
  const totalPages = Math.ceil(tamilNaduMedicalColleges.length / itemsPerPage);
  const indexOfLastItem = currentPage * itemsPerPage;
  const indexOfFirstItem = indexOfLastItem - itemsPerPage;
  
  // 3. The specific 10 items for the current page
  const currentItems = tamilNaduMedicalColleges.slice(indexOfFirstItem, indexOfLastItem);
    ...
    <div style={styles.pageContainer}>
      ...
      <header style={styles.heroHeader}>
        <div style={styles.heroContent}>
          ...
          <h1 style={styles.mainTitle}>Medical Colleges in Tamil Nadu</h1>
          <p style={styles.subtitle}>
            A complete directory of institutions offering MBBS programs across Tamil Nadu.
          </p>
