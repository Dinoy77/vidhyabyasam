export const newsItems = [
  ...
  },
  {
    ...
    bg: "#ECFDF5", 
    tag: "Allotment Today",
    title: "TS EAPCET (EAMCET) 2026 — Phase 1 Seat Allotment Result Live",
    isNotification: true,
    date: "Allotment: July 10",
    publishedAt: "2026-07-10",
    image: "https://images.unsplash.com/photo-1562774053-701939374585?w=400&q=80",
    description: "The Telangana Council of Higher Education (TGCHE) is announcing the Phase 1 Seat Allotment results today, July 10, 2026. Engineering and pharmacy candidates must log in, verify their assigned institute, pay tuition fees, and complete self-reporting.",
    eligibility: "Candidates who froze their web options and completed certificate verification",
    applyLink: "https://tgeapcet.nic.in",
    courses: ["B.Tech", "B.Pharm"],
    state: "Telangana"
  },
  {
  ...
  },
  {
    ...
    color: "#DC2626", 
    bg: "#FFF0F0", 
    tag: "Seat Allotment Out",
    title: "TS EAPCET 2026 — Phase 1 Counselling Allotment Portal Live",
    date: "Reporting Open Now",
    publishedAt: "2026-07-11",
    image: "https://images.unsplash.com/photo-1562774053-701939374585?w=400&q=80",
    description: "The Telangana Council of Higher Education (TGCHE) has fully live-tracked the Phase 1 provisional seat allotment orders. Selected engineering and pharmacy applicants must complete online self-reporting and pay college tuition allocations immediately via the candidate dashboard.",
    eligibility: "Candidates assigned a seat in Phase 1 who need to secure admission via fee payment",
    applyLink: "https://tgeapcet.nic.in",
    courses: ["B.Tech", "B.Pharm"],
    state: "Telangana"
  }
